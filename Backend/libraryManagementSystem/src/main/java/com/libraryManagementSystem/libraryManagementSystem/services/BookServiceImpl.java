...
public class BookServiceImpl implements BookService{
    ...
    public BookDTO createBook(BookDTO bookdto) {
        ...
        //Map authors from DTO
        List<AuthorEntity> authorEntities = new ArrayList<>();
        for (AuthorDTO authorDTO : bookdto.getAuthors()) {
            AuthorEntity author = authorRepository.findById(authorDTO.getId())
                    .orElseThrow(() -> new NoSuchElementException("Author is not found with id: " + authorDTO.getId()));
        ...
        //convert back to DTO manually
        BookDTO savedDTO = new BookDTO();
        savedDTO.setId(savedBook.getId());
        savedDTO.setTitle(savedBook.getTitle());

        List<AuthorDTO> authorDTOS = new ArrayList<>();
        for (AuthorEntity author : savedBook.getAuthors()) {
        ...
        savedDTO.setAuthors(authorDTOS);
